...
#define RPL_WELCOME(nick, username)								std::string(":") + SERVER_NAME + " 001 " + nick + " :Welcome to the Internet Relay Network " + username + "!~" + nick + "@localhost"
